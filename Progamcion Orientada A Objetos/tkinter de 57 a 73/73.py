...
class Aplicacion:
    ...
    def grafico_barra(self):
        ...
        self.canvas1.create_rectangle(10,10,10+largo1,90,fill="blue")
        self.canvas1.create_rectangle(10,120,10+largo2,200,fill="orange")
        self.canvas1.create_rectangle(10,230,10+largo3,310,fill="red")
