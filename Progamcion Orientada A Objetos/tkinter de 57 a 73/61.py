...
class Aplicacion:
    def __init__(self):
        ...
        self.check1=tk.Checkbutton(self.ventana1,text="INTEC", variable=self.seleccion1)
        self.check1.grid(column=0, row=0)
        self.seleccion2=tk.IntVar()
        self.check2=tk.Checkbutton(self.ventana1,text="ITLA", variable=self.seleccion2)
        self.check2.grid(column=0, row=1)
        self.seleccion3=tk.IntVar()
        self.check3=tk.Checkbutton(self.ventana1,text="LOYOLA", variable=self.seleccion3)
        self.seleccion4=tk.IntVar()
        self.check3.grid(column=0, row=2)
        self.check4=tk.Checkbutton(self.ventana1,text="INFOTEP", variable=self.seleccion4)
